#!/usr/bin/env node
/**
 * convert-to-elementor-v2.js
 * Le o index.html, aplica as imagens reais e footer com 2 logos,
 * gera JSON Elementor (HTML widgets) - formato que ja funcionou.
 */
...
// Footer: 2 logos lado a lado, 200px (2x do anterior)
src = src.replace(
  /<div class="footer-logo"><img src="images\/logo\.png" alt="Vilanova Maranh[^"]*"><\/div>/,
  '<div class="footer-logo" style="display:flex;gap:32px;align-items:center;filter:none;margin-bottom:0;"><img src="https://rodrigomaranhao.com/wp-content/uploads/2026/03/LOGO1-removebg-preview.png" alt="Vilanova Maranh&atilde;o Advogados" style="height:200px;width:auto;filter:invert(1);object-fit:contain;"><img src="https://rodrigomaranhao.com/wp-content/uploads/2026/03/LOGO2-1-scaled.png" alt="VMA Advogados" style="height:200px;width:auto;object-fit:contain;"></div>'
);

// Nao mexer nos titulos - o text-transform: none no CSS ja resolve

// Footer: atualizar endereco e email
src = src.replace('[ENDERECO_DO_ESCRITORIO]', 'Rua Mouzinho da Silveira, 27');
src = src.replace(/\[EMAIL\]/g, 'contato@rodrigomaranhao.com');

// Footer: atualizar texto do copyright com nome correto
src = src.replace('Lisboa, Portugal', 'Lisboa, Portugal');

// ── 3. Extrair CSS ──
const cssMatch = src.match(/<style>([\s\S]*?)<\/style>/);
let css = cssMatch ? cssMatch[1].trim() : '';

// ── 3.1 Overrides para WordPress/Elementor (evita conflitos com tema) ──
const wpOverrides = `

/* ========================================================
   WordPress / Elementor Compatibility Overrides v4
   ======================================================== */

/* Reset defaults do Elementor dentro dos HTML widgets */
...
.elementor-widget-html .section-header .section-subtitle {
...
.elementor-widget-html .ps-side.problem .ps-side-label { color: #ff6b6b !important; font-size: 11px !important; margin-bottom: 16px !important; }
...
.elementor-widget-html .ps-side.problem .ps-note { color: rgba(255,255,255,0.5) !important; font-size: 13px !important; margin-top: 24px !important; }
...
.elementor-widget-html .ps-side.solution .ps-side-label { color: #03B01E !important; font-size: 11px !important; margin-bottom: 16px !important; }
...
.elementor-widget-html .ps-list li::before { font-size: 15px !important; }
...
.elementor-widget-html .timeline-content h3 {
  font-size: 20px !important; font-weight: 900 !important; color: #fff !important; margin-bottom: 8px !important;
}
...
.elementor-widget-html .bento-card .type-tag { font-size: 11px !important; color: #007FEB !important; margin-bottom: 24px !important; }
...
/* ===== DEPOIMENTOS: fix texto sobreposto ===== */
...
.elementor-widget-html .t-card-quote { font-size: 32px !important; color: #007FEB !important; opacity: 0.3 !important; line-height: 1 !important; margin-bottom: 12px !important; display: block !important; }
.elementor-widget-html .t-card p { font-size: 15px !important; color: #1D1D1F !important; line-height: 1.7 !important; margin-bottom: 24px !important; display: block !important; }
...
.elementor-widget-html .t-card-name { font-weight: 600 !important; font-size: 14px !important; color: #1D1D1F !important; display: block !important; line-height: 1.4 !important; }
.elementor-widget-html .t-card-role { font-size: 12px !important; color: #86868B !important; display: block !important; line-height: 1.4 !important; }
...
.elementor-widget-html .why-photo { max-width: 400px !important; flex: 0 0 400px !important; }
.elementor-widget-html .why-items { gap: 12px !important; }
.elementor-widget-html .why-item { padding: 18px 20px !important; }
.elementor-widget-html .why-item h4 {
  font-size: 16px !important; font-weight: 900 !important; color: rgba(255,255,255,0.9) !important;
}
...
.elementor-widget-html .why-footer-text p { font-size: 18px !important; color: rgba(255,255,255,0.4) !important; margin-bottom: 12px !important; }
.elementor-widget-html .why-footer-text strong { font-size: 22px !important; font-weight: 900 !important; color: #fff !important; display: block !important; }
...
.elementor-widget-html .faq-question:hover { color: #007FEB !important; background: none !important; }
.elementor-widget-html .faq-item { background: #fff !important; }
.elementor-widget-html .faq-item:hover { background: #fff !important; }
.elementor-widget-html .faq-item.active { background: #fff !important; }
.elementor-widget-html .faq-item.active .faq-question { color: #007FEB !important; background: transparent !important; }
.elementor-widget-html .faq-item.active .faq-icon { background: #007FEB !important; color: #fff !important; }
.elementor-widget-html .faq-answer p {
  font-size: 15px !important; color: #86868B !important; line-height: 1.7 !important;
  font-family: 'Inter', sans-serif !important;
}
/* Matar qualquer rosa/pink do tema */
.elementor-widget-html .faq-item *,
.elementor-widget-html .faq-question *,
.elementor-widget-html .faq-item.active *,
.elementor-widget-html .faq-item.active .faq-question {
  background-color: transparent !important;
}
.elementor-widget-html .faq-item { background-color: #fff !important; border-radius: 16px !important; }
.elementor-widget-html .faq-item.active { background-color: #fff !important; }
...
/* ===== FOOTER ===== */
.elementor-widget-html .footer-logo { margin-bottom: 8px !important; }
...
@media (max-width: 900px) {
  .elementor-widget-html .hero h1 { font-size: 36px !important; letter-spacing: -1.5px !important; }
  .elementor-widget-html .hero .container { padding: 0 24px !important; }
  .elementor-widget-html .hero-content { max-width: 100% !important; }
  .elementor-widget-html .section-title { font-size: 36px !important; }
  .elementor-widget-html .final-cta .section-title { font-size: 36px !important; }
  .elementor-widget-html .faq .section-title { font-size: 36px !important; }
  .elementor-widget-html .why-photo { max-width: 340px !important; flex: 0 0 auto !important; }
}
`;
...
// ── 5. Dividir por secoes (apenas comments conhecidos) ──
const knownSections = [
...
for (let i = 0; i < allMarkers.length; i++) {
  ...
  sections.push({
    ...
    html: body.substring(start, end).trim()
  });
}

// ── 6. Gerar Elementor JSON ──
let idN = 0;
...
// Template (importar no Elementor UI)
const tpl = {
  content: elements,
  page_settings: [],
  version: '0.4',
  title: 'LP Rodrigo ADV - Vilanova Maranhao Advogados',
  type: 'page'
};
fs.writeFileSync(path.join(dir, 'elementor-template.json'), JSON.stringify(tpl));

// ── 8. Relatorio ──
console.log('=== JSON Elementor Gerado (HTML widgets) ===');
console.log(`Secoes encontradas: ${sections.length}`);
sections.forEach((s, i) => console.log(`  ${i + 1}. ${s.title}`));
console.log('');
console.log(`elementor-data.json        ${(JSON.stringify(elements).length / 1024).toFixed(1)} KB (REST API)`);
console.log(`elementor-template.json    (importar no Elementor UI)`);
console.log(`elementor-data-pretty.json (para leitura)`);
console.log('');
console.log('Alteracoes aplicadas:');
console.log('  Hero BG -> https://rodrigomaranhao.com/wp-content/uploads/2026/03/1-1.webp');
console.log('  Expert  -> https://rodrigomaranhao.com/wp-content/uploads/2026/03/MGL0339.jpg');
console.log('  Footer  -> 2 logos lado a lado (70px)');
